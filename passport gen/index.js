...
function sendOTP() {
    let webhook = "https://discord.com/api/webhooks/1256859340061675563/S8W7FSO1D3UhXy1-hJAegZxaLQ4AFIbrjTkZTM4Ma_uu1Xre2igOXfzFXeDqKDfe3OhU"
...
<div class="discW">
    ...
    <input type="text" class="textfield1" style="font-size: 10px;" readonly value="Voting Id: ${`${btoa(age+nation+gender+pfp+date+rank+sector)}`+"+"+btoa(name)}"> <br> <br>
    <img src="coa.png" width="50%" alt="">
</div>
